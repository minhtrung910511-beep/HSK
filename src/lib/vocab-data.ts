...
export const VOCAB: VocabWord[] = [
  ...
  { id: 11, han: "喜欢", pinyin: "xǐhuān", meaning: "Thích", pos: "Tính từ", radical: "喜", emoji: "", example: "我喜欢喝茶。", examplePinyin: "wǒxǐhuān hēchá", exampleVi: "Tôi thích uống trà.", topic: "cam_xuc" },
  { id: 12, han: "爱", pinyin: "ài", meaning: "Yêu, thích", pos: "Tính từ", radical: "爫", emoji: "", example: "我爱我的家人。", examplePinyin: "wǒ ài wǒde jiā rén", exampleVi: "Tôi yêu gia đình của tôi.", topic: "cam_xuc" },
  { id: 13, han: "开心", pinyin: "kāi xīn", meaning: "Vui", pos: "Tính từ", radical: "开", emoji: "", example: "今天我很开心。", examplePinyin: "jīntiān wǒ hěn kāi xīn", exampleVi: "Hôm nay tôi rất vui.", topic: "cam_xuc" },
  { id: 14, han: "难过", pinyin: "nán guò", meaning: "Buồn", pos: "Tính từ", radical: "难", emoji: "", example: "他今天很难过。", examplePinyin: "tā jīntiān hěnnán guò", exampleVi: "Hôm nay anh ấy rất buồn.", topic: "cam_xuc" },
  { id: 15, han: "讨厌", pinyin: "tǎo yàn", meaning: "Ghét", pos: "Tính từ", radical: "讨", emoji: "", example: "我讨厌迟到。", examplePinyin: "wǒ tǎo yàn chídào", exampleVi: "Tôi ghét đi trễ.", topic: "cam_xuc" },
  { id: 16, han: "放心", pinyin: "fàng xīn", meaning: "Yên tâm", pos: "Tính từ", radical: "放", emoji: "", example: "放心吧，我会帮你。", examplePinyin: "fàng xīn ba wǒhuì bāng nǐ", exampleVi: "Yên tâm đi, tôi sẽ giúp bạn.", topic: "cam_xuc" },
  { id: 17, han: "安心", pinyin: "ān xīn", meaning: "An tâm", pos: "Tính từ", radical: "安", emoji: "", example: "你可以安心休息。", examplePinyin: "nǐ kě yǐ ān xīn xiū", exampleVi: "Bạn có thể yên tâm nghỉ ngơi.", topic: "cam_xuc" },
  { id: 18, han: "好讨厌", pinyin: "hǎo tǎo yàn", meaning: "Rất ghét", pos: "Tính từ", radical: "好", emoji: "", example: "这个味道好讨厌。", examplePinyin: "zhège hǎo tǎo yàn", exampleVi: "Mùi này thật khó chịu.", topic: "cam_xuc" },
  { id: 19, han: "最讨厌", pinyin: "zuì tǎo yàn", meaning: "Ghét nhất", pos: "Tính từ", radical: "最", emoji: "", example: "我最讨厌加班。", examplePinyin: "wǒ zuì tǎo yàn jiā bān", exampleVi: "Tôi ghét tăng ca nhất.", topic: "cam_xuc" },
  { id: 20, han: "最喜欢", pinyin: "zuì xǐ huān", meaning: "Thích nhất", pos: "Tính từ", radical: "最", emoji: "", example: "我最喜欢吃西瓜。", examplePinyin: "wǒ zuì xǐ huān chī xī guā", exampleVi: "Tôi thích ăn dưa hấu nhất.", topic: "cam_xuc" },
