...
export const VOCAB: VocabWord[] = [
  ...
  { id: 169, han: "几", pinyin: "jǐ", meaning: "Mấy? (hỏi số lượng bao nhiêu)", pos: "Số từ", emoji: "🔢", example: "几。", examplePinyin: "jǐ.", exampleVi: "Mấy.", topic: "numbers" },
  { id: 170, han: "了", pinyin: "le", meaning: "Động từ +了: Nhấn mạnh hành động xong xuôi. 了 nằm cuối câu: Nhấn mạnh trạng thái thay đổi.", pos: "Trợ từ", emoji: "✓", example: "了。", examplePinyin: "le.", exampleVi: "Động từ +了: Nhấn mạnh hành động xong xuôi..", topic: "numbers" },
