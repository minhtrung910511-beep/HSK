...
export const VOCAB: VocabWord[] = [
  // ===== 1. CHÀO HỎI (10 từ) =====
  { id: 1,  han: "你好",   pinyin: "nǐ hǎo",       meaning: "xin chào",            pos: "Thán từ",   emoji: "👋", example: "你好，我叫小明。",        examplePinyin: "Nǐ hǎo, wǒ jiào Xiǎomíng.",         exampleVi: "Xin chào, tôi tên là Tiểu Minh.", topic: "chao_hoi" },
  ...
  { id: 10, han: "欢迎",   pinyin: "huān yíng",    meaning: "hoan nghênh",         pos: "Động từ",   emoji: "🎉", example: "欢迎你们来中国！",        examplePinyin: "Huānyíng nǐmen lái Zhōngguó!",      exampleVi: "Hoan nghênh các bạn đến Trung Quốc!", topic: "chao_hoi" },
  ...
  { id: 18, han: "他们",   pinyin: "tā men",       meaning: "họ (nam)",            pos: "Đại từ",    emoji: "👬", example: "他们在学校。",            examplePinyin: "Tāmen zài xuéxiào.",                exampleVi: "Họ đang ở trường.", topic: "ai_tu_xung_ho" },
  ...
  { id: 25, han: "为什么", pinyin: "wèi shén me",  meaning: "tại sao",             pos: "Đại từ",    emoji: "💭", example: "你为什么不去上课？",            examplePinyin: "nǐ wèi shénme bú qù shàngkè?",                  exampleVi: "Tại sao bạn không đi học?", topic: "ai_tu_xung_ho" },
  ...
  { id: 28, han: "哥哥",   pinyin: "gē ge",        meaning: "anh trai",            pos: "Danh từ",   emoji: "👦", example: "我的哥哥很高。",              examplePinyin: "wǒ de gēge hěn gāo.",                     exampleVi: "Anh trai tôi rất cao.", topic: "gia_inh" },
  { id: 29, han: "弟弟",   pinyin: "dì di",        meaning: "em trai",             pos: "Danh từ",   emoji: "👦", example: "弟弟今年五岁。",          examplePinyin: "Dìdi jīnnián wǔ suì.",              exampleVi: "Em trai tôi năm nay 5 tuổi.", topic: "gia_inh" },
  { id: 30, han: "姐姐",   pinyin: "jiě jie",      meaning: "chị gái",             pos: "Danh từ",   emoji: "👧", example: "姐姐是学生。",            examplePinyin: "Jiějie shì xuéshēng.",              exampleVi: "Chị gái là học sinh.", topic: "gia_inh" },
  { id: 31, han: "妹妹",   pinyin: "mèi mei",      meaning: "em gái",              pos: "Danh từ",   emoji: "👧", example: "妹妹很可爱。",            examplePinyin: "Mèimei hěn kě'ài.",                 exampleVi: "Em gái rất đáng yêu.", topic: "gia_inh" },
  ...
  { id: 35, han: "孩子",   pinyin: "hái zi",       meaning: "đứa trẻ / con cái",   pos: "Danh từ",   emoji: "🧒", example: "孩子们在玩儿。",          examplePinyin: "Háizimen zài wánr.",                exampleVi: "Các em đang chơi.", topic: "nghe_nghiep" },
  ...
  { id: 37, han: "太太",   pinyin: "tài tai",      meaning: "bà / phu nhân / vợ",  pos: "Danh từ",   emoji: "👰", example: "李太太很热情。",          examplePinyin: "Lǐ tàitai hěn rèqíng.",             exampleVi: "Bà Lý rất nhiệt tình.", topic: "nghe_nghiep" },
  ...
  { id: 39, han: "一",     pinyin: "yī",           meaning: "một",                 pos: "Số từ",     emoji: "1️⃣", example: "我有一个苹果。",         examplePinyin: "Wǒ yǒu yí ge píngguǒ.",             exampleVi: "Tôi có một quả táo.", topic: "so_luong" },
  { id: 40, han: "二",     pinyin: "èr",           meaning: "hai",                 pos: "Số từ",     emoji: "2️⃣", example: "我二十岁。",             examplePinyin: "Wǒ èrshí suì.",                     exampleVi: "Tôi hai mươi tuổi.", topic: "so_luong" },
  { id: 41, han: "三",     pinyin: "sān",          meaning: "ba",                  pos: "Số từ",     emoji: "3️⃣", example: "三个人在这儿。",         examplePinyin: "Sān ge rén zài zhèr.",              exampleVi: "Ba người ở đây.", topic: "so_luong" },
  { id: 42, han: "四",     pinyin: "sì",           meaning: "bốn",                 pos: "Số từ",     emoji: "4️⃣", example: "桌子上有四本书。",       examplePinyin: "Zhuōzi shàng yǒu sì běn shū.",      exampleVi: "Trên bàn có bốn quyển sách.", topic: "so_luong" },
  { id: 43, han: "五",     pinyin: "wǔ",           meaning: "năm",                 pos: "Số từ",     emoji: "5️⃣", example: "我有五个朋友。",         examplePinyin: "Wǒ yǒu wǔ ge péngyou.",             exampleVi: "Tôi có năm người bạn.", topic: "so_luong" },
  { id: 44, han: "六",     pinyin: "liù",          meaning: "sáu",                 pos: "Số từ",     emoji: "6️⃣", example: "现在六点。",             examplePinyin: "Xiànzài liù diǎn.",                 exampleVi: "Bây giờ là sáu giờ.", topic: "so_luong" },
  { id: 45, han: "七",     pinyin: "qī",           meaning: "bảy",                 pos: "Số từ",     emoji: "7️⃣", example: "一周有七天。",           examplePinyin: "Yì zhōu yǒu qī tiān.",              exampleVi: "Một tuần có bảy ngày.", topic: "so_luong" },
  { id: 46, han: "八",     pinyin: "bā",           meaning: "tám",                 pos: "Số từ",     emoji: "8️⃣", example: "八月很热。",             examplePinyin: "Bā yuè hěn rè.",                    exampleVi: "Tháng tám rất nóng.", topic: "so_luong" },
  { id: 47, han: "九",     pinyin: "jiǔ",          meaning: "chín",                pos: "Số từ",     emoji: "9️⃣", example: "九点开始上课。",         examplePinyin: "Jiǔ diǎn kāishǐ shàngkè.",          exampleVi: "Chín giờ bắt đầu học.", topic: "so_luong" },
  { id: 48, han: "十",     pinyin: "shí",          meaning: "mười",                pos: "Số từ",     emoji: "🔟", example: "十个人来了。",           examplePinyin: "Shí ge rén lái le.",                exampleVi: "Mười người đã đến.", topic: "so_luong" },
  { id: 49, han: "百",     pinyin: "bǎi",          meaning: "trăm",                pos: "Số từ",     emoji: "💯", example: "一百个学生。",           examplePinyin: "Yì bǎi ge xuéshēng.",               exampleVi: "Một trăm học sinh.", topic: "so_luong" },
  ...
  { id: 52, han: "零",     pinyin: "líng",         meaning: "số không",            pos: "Số từ",     emoji: "0️⃣", example: "电话号码是零。",         examplePinyin: "Diànhuà hàomǎ shì líng.",           exampleVi: "Số điện thoại có số không.", topic: "so_luong" },
  { id: 53, han: "两",     pinyin: "liǎng",        meaning: "hai (với lượng từ)",  pos: "Số từ",     emoji: "✌️", example: "我有两个苹果。",         examplePinyin: "Wǒ yǒu liǎng ge píngguǒ.",          exampleVi: "Tôi có hai quả táo.", topic: "so_luong" },
  ...
  { id: 58, han: "日",     pinyin: "rì",           meaning: "ngày / mặt trời",     pos: "Danh từ",   emoji: "☀️", example: "十月一日是国庆节。",     examplePinyin: "Shí yuè yí rì shì guóqìng jié.",    exampleVi: "Mùng 1 tháng 10 là Quốc khánh.", topic: "thoi_gian" },
  ...
  { id: 71, han: "时间",   pinyin: "shí jiān",     meaning: "thời gian",           pos: "Danh từ",   emoji: "⏳", example: "时间过得真快！",         examplePinyin: "Shíjiān guò de zhēn kuài!",         exampleVi: "Thời gian trôi nhanh thật!", topic: "thoi_gian" },
  ...
  { id: 78, han: "电话",   pinyin: "diàn huà",     meaning: "điện thoại",          pos: "Danh từ",   emoji: "📞", example: "你的电话号码是多少？",   examplePinyin: "Nǐ de diànhuà hàomǎ shì duōshao?",  exampleVi: "Số điện thoại của bạn là bao nhiêu?", topic: "o_dung" },
  ...
  { id: 80, han: "笔",     pinyin: "bǐ",           meaning: "bút",                 pos: "Danh từ",   emoji: "🖊️", example: "你有几支笔？",          examplePinyin: "Nǐ yǒu jǐ zhī bǐ?",                 exampleVi: "Bạn có mấy cây bút?", topic: "o_dung" },
  ...
  { id: 82, han: "伞",     pinyin: "sǎn",          meaning: "ô / dù",              pos: "Danh từ",   emoji: "☂️", example: "今天带伞了吗？",        examplePinyin: "Jīntiān dài sǎn le ma?",            exampleVi: "Hôm nay bạn mang ô chưa?", topic: "o_dung" },
  { id: 83, han: "表",     pinyin: "biǎo",         meaning: "đồng hồ đeo tay",     pos: "Danh từ",   emoji: "⌚", example: "我的表很准。",           examplePinyin: "Wǒ de biǎo hěn zhǔn.",              exampleVi: "Đồng hồ của tôi rất chuẩn.", topic: "o_dung" },
  ...
  { id: 85, han: "票",     pinyin: "piào",         meaning: "vé",                  pos: "Danh từ",   emoji: "🎟️", example: "买两张票。",            examplePinyin: "Mǎi liǎng zhāng piào.",             exampleVi: "Mua hai tấm vé.", topic: "o_dung" },
  ...
  { id: 90, han: "饭",     pinyin: "fàn",          meaning: "cơm / bữa ăn",        pos: "Danh từ",   emoji: "🍚", example: "你吃饭了吗？",           examplePinyin: "Nǐ chī fàn le ma?",                 exampleVi: "Bạn ăn cơm chưa?", topic: "o_an" },
  ...
  { id: 94, han: "鸡蛋",   pinyin: "jī dàn",       meaning: "trứng gà",            pos: "Danh từ",   emoji: "🥚", example: "早上我吃鸡蛋。",         examplePinyin: "Zǎoshang wǒ chī jīdàn.",            exampleVi: "Buổi sáng tôi ăn trứng.", topic: "o_an" },
  { id: 95, han: "牛奶",   pinyin: "niú nǎi",      meaning: "sữa bò",              pos: "Danh từ",   emoji: "🥛", example: "我喜欢喝牛奶。",         examplePinyin: "Wǒ xǐhuan hē niúnǎi.",              exampleVi: "Tôi thích uống sữa.", topic: "o_an" },
  ...
  { id: 98, han: "鱼",     pinyin: "yú",           meaning: "cá",                  pos: "Danh từ",   emoji: "🐟", example: "我不吃鱼。",             examplePinyin: "Wǒ bù chī yú.",                     exampleVi: "Tôi không ăn cá.", topic: "o_an" },
  { id: 99, han: "肉",     pinyin: "ròu",          meaning: "thịt",                pos: "Danh từ",   emoji: "🥩", example: "他爱吃肉。",             examplePinyin: "Tā ài chī ròu.",                    exampleVi: "Anh ấy thích ăn thịt.", topic: "o_an" },

  // ===== 8. CƠ THỂ (5 từ) =====
  { id: 100, han: "头",    pinyin: "tóu",          meaning: "đầu",                 pos: "Danh từ",   emoji: "🗣️", example: "我头疼。",               examplePinyin: "Wǒ tóu téng.",                      exampleVi: "Tôi đau đầu.", topic: "co_the" },
  { id: 101, han: "手",    pinyin: "shǒu",         meaning: "tay",                 pos: "Danh từ",   emoji: "✋", example: "他的手很大。",           examplePinyin: "Tā de shǒu hěn dà.",                exampleVi: "Tay anh ấy rất to.", topic: "co_the" },
  { id: 102, han: "脚",    pinyin: "jiǎo",         meaning: "chân / bàn chân",     pos: "Danh từ",   emoji: "🦶", example: "我的脚很冷。",           examplePinyin: "Wǒ de jiǎo hěn lěng.",              exampleVi: "Chân tôi rất lạnh.", topic: "co_the" },
  { id: 103, han: "眼睛",  pinyin: "yǎn jing",     meaning: "mắt",                 pos: "Danh từ",   emoji: "👁️", example: "她的眼睛很大。",        examplePinyin: "Tā de yǎnjing hěn dà.",             exampleVi: "Mắt cô ấy rất to.", topic: "co_the" },
  { id: 104, han: "嘴",    pinyin: "zuǐ",          meaning: "miệng",               pos: "Danh từ",   emoji: "👄", example: "他的嘴很小。",           examplePinyin: "Tā de zuǐ hěn xiǎo.",               exampleVi: "Miệng anh ấy rất nhỏ.", topic: "co_the" },
  ...
  { id: 106, han: "听",    pinyin: "tīng",         meaning: "nghe",                pos: "Động từ",   emoji: "👂", example: "请听我说。",             examplePinyin: "Qǐng tīng wǒ shuō.",                exampleVi: "Xin hãy nghe tôi nói.", topic: "hanh_ong" },
  ...
  { id: 114, han: "站",    pinyin: "zhàn",         meaning: "đứng",                pos: "Động từ",   emoji: "🧍", example: "请站起来。",             examplePinyin: "Qǐng zhàn qǐlái.",                  exampleVi: "Xin đứng lên.", topic: "hanh_ong" },
  { id: 115, han: "走",    pinyin: "zǒu",          meaning: "đi bộ",               pos: "Động từ",   emoji: "🚶‍♂️", example: "我们走吧。",          examplePinyin: "Wǒmen zǒu ba.",                     exampleVi: "Chúng ta đi thôi.", topic: "hanh_ong" },
  ...
  { id: 124, han: "教",    pinyin: "jiāo",         meaning: "dạy",                 pos: "Động từ",   emoji: "👨‍🏫", example: "他教我们汉语。",      examplePinyin: "Tā jiāo wǒmen Hànyǔ.",              exampleVi: "Anh ấy dạy chúng tôi tiếng Trung.", topic: "hanh_ong" },
  { id: 125, han: "认识",  pinyin: "rèn shi",      meaning: "biết / quen / nhận thức", pos: "Động từ", emoji: "🤝", example: "我认识他。",         examplePinyin: "Wǒ rènshi tā.",                     exampleVi: "Tôi quen anh ấy.", topic: "hanh_ong" },
  ...
  { id: 130, han: "坏",    pinyin: "huài",         meaning: "xấu / hỏng",          pos: "Tính từ",   emoji: "👎", example: "电视坏了。",             examplePinyin: "Diànshì huài le.",                  exampleVi: "Tivi hỏng rồi.", topic: "mieu_ta" },
  ...
  { id: 132, han: "小",    pinyin: "xiǎo",         meaning: "nhỏ , bé",                 pos: "Tính từ",   emoji: "🐜", example: "我的狗很小。",           examplePinyin: "Wǒ de gǒu hěn xiǎo.",               exampleVi: "Chó của tôi rất nhỏ.", topic: "mieu_ta" },
  ...
  { id: 135, han: "高",    pinyin: "gāo",          meaning: "cao",                 pos: "Tính từ",   emoji: "📏", example: "他很高。",               examplePinyin: "Tā hěn gāo.",                       exampleVi: "Anh ấy rất cao.", topic: "mieu_ta" },
  ...
  { id: 138, han: "新",    pinyin: "xīn",          meaning: "mới",                 pos: "Tính từ",   emoji: "🆕", example: "这是新衣服。",           examplePinyin: "Zhè shì xīn yīfu.",                 exampleVi: "Đây là quần áo mới.", topic: "mieu_ta" },
  { id: 139, han: "旧",    pinyin: "jiù",          meaning: "cũ",                  pos: "Tính từ",   emoji: "📜", example: "这是一本旧书。",         examplePinyin: "Zhè shì yì běn jiù shū.",           exampleVi: "Đây là một quyển sách cũ.", topic: "mieu_ta" },
  ...
  { id: 141, han: "贵",    pinyin: "guì",          meaning: "đắt",                 pos: "Tính từ",   emoji: "💎", example: "这个太贵了。",           examplePinyin: "Zhège tài guì le.",                 exampleVi: "Cái này quá đắt.", topic: "mieu_ta" },
  { id: 142, han: "便宜",  pinyin: "pián yi",      meaning: "rẻ",                  pos: "Tính từ",   emoji: "🪙", example: "这个很便宜。",           examplePinyin: "Zhège hěn piányi.",                 exampleVi: "Cái này rất rẻ.", topic: "mieu_ta" },
  { id: 143, han: "快",    pinyin: "kuài",         meaning: "nhanh",               pos: "Tính từ",   emoji: "⚡", example: "他跑得很快。",           examplePinyin: "Tā pǎo de hěn kuài.",               exampleVi: "Anh ấy chạy rất nhanh.", topic: "mieu_ta" },
  { id: 144, han: "慢",    pinyin: "màn",          meaning: "chậm",                pos: "Tính từ",   emoji: "🐌", example: "请慢走。",               examplePinyin: "Qǐng màn zǒu.",                     exampleVi: "Xin đi từ từ.", topic: "mieu_ta" },
  ...
  { id: 148, han: "饭店",  pinyin: "fàn diàn",     meaning: "nhà hàng",            pos: "Danh từ",   emoji: "🏨", example: "这家饭店很好。",         examplePinyin: "Zhè jiā fàndiàn hěn hǎo.",          exampleVi: "Nhà hàng này rất tốt.", topic: "ia_iem" },
  { id: 149, han: "房间",  pinyin: "fáng jiān",    meaning: "phòng",               pos: "Danh từ",   emoji: "🚪", example: "我的房间很干净。",       examplePinyin: "Wǒ de fángjiān hěn gānjìng.",       exampleVi: "Phòng của tôi rất sạch.", topic: "ia_iem" },
  { id: 150, han: "里",    pinyin: "lǐ",           meaning: "trong / bên trong",   pos: "Danh từ",   emoji: "📥", example: "杯子里有水。",           examplePinyin: "Bēizi lǐ yǒu shuǐ.",                exampleVi: "Trong cốc có nước.", topic: "ia_iem" },
  ...
  { id: 171, han: "了", pinyin: "le", meaning: "了nằm cuối câu: Nhấn mạnh trạng thái thay đổi", pos: "Trợ từ", emoji: "✓", example: "下雨了。", examplePinyin: "xià yǔ le", exampleVi: "Trời mưa rồi.", topic: "ngu_phap" },
  ...
  { id: 181, han: "几", pinyin: "jǐ", meaning: "Mấy? (hỏi số lượng bao nhiêu)", pos: "Số từ", emoji: "🔢", example: "你有几个苹果？", examplePinyin: "nǐ yǒu jǐ gè píng guǒ", exampleVi: "Bạn có mấy quả táo?", topic: "so_luong" },
  ...
  // --- Bài 9 ---
  { id: 183, han: "猫", pinyin: "māo", meaning: "Con mèo", pos: "Danh từ", emoji: "", example: "这只猫很可爱。", examplePinyin: "zhè zhī māo hěn kě ài", exampleVi: "Con mèo này rất đáng yêu.", topic: "hanh_ong" },
  ...
  { id: 185, han: "那儿", pinyin: "nàr", meaning: "Đó, nơi đó", pos: "Đại từ", emoji: "", example: "商店在那儿。", examplePinyin: "shāngdiàn zài nàr", exampleVi: "Cửa hàng ở đó.", topic: "hanh_ong" },
  { id: 186, han: "狗", pinyin: "gǒu", meaning: "con chó", pos: "Danh từ", emoji: "", example: "这只狗很可爱。", examplePinyin: "zhè zhī gǒu hěn kě'ài", exampleVi: "Con chó này rất đáng yêu.", topic: "hanh_ong" },
  ...
  { id: 221, han: "下", pinyin: "xià", meaning: "Rơi", pos: "Danh từ", emoji: "", example: "苹果从树上下来。", examplePinyin: "píng guǒ cóng shù shàng xià lái", exampleVi: "Quả táo rơi từ trên cây xuống.", topic: "thoi_gian" },
